<template>
  <b-container fluid style="font-size: 14px">
    <b-row>
    ...
    <b-row align-v="start">
      <b-col v-for="market in listMarketBook" style="width: 50%;max-width: 360px" :key="market.marketId">
        marketId:{{market.marketId}}
        <div v-for="runner in market.runners" :key="runner.selectionId">
          <div style="display: flex">
